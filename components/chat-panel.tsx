...
export function ChatPanel({
  ...
  const exampleMessages = [
    {
      heading: 'Translate "Hello, how are you?"',
      subheading: 'from English to Mandarin',
      message: `Translate "Hello, how are you?" from English to Mandarin`
    },
    {
      heading: 'How do you say "Thank you" in Mandarin?',
      subheading: 'Request translation for a specific phrase',
      message: 'How do you say "Thank you" in Mandarin?'
    }
  ]

...
export function PromptForm({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative flex max-h-60 w-full grow flex-col overflow-hidden bg-zinc-100 px-12 sm:rounded-md sm:px-12">
        <Button
          variant="outline"
          size="icon"
        ...
        <Textarea
          ...
          // Add minRows and maxRows to handle resizing
          minRows={1}
          maxRows={10}
        />
